...
image::img/transaction-simulation.png[Transaction Simulation in Hyperledger Fabric]
...
INFO: The HLF platform is actively developed.
...
INFO: This tutorial is based on the https://github.com/hyperledger-labs/fablo/releases/tag/1.2.0[**1.2.0**] release of Fablo.
